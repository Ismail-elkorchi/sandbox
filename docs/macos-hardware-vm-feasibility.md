...
This report records the platform design and the proof still required before a macOS hardware-VM extension may be exposed. For registered implementations, see the [support matrix](backends.md); for the working Linux VM extension, see [hardware VMs](hardware-vm.md).
